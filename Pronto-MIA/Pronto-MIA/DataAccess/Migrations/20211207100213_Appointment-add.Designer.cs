...
namespace Pronto_MIA.DataAccess.Migrations
{
    ...
    [Migration("20211207100213_Appointment-add")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pronto_MIA.Domain.Entities.AccessControlList", b =>
                {
                    ...
                    b.Property<bool>("CanEditDepartmentUsers")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("CanEditEducationalContent")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanEditExternalNews")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanEditInternalNews")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanEditOwnDepartment")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("CanViewDepartmentUsers")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("CanViewEducationalContent")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanViewExternalNews")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanViewInternalNews")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanViewOwnDepartment")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Pronto_MIA.Domain.Entities.EducationalContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("EducationalContent");
                });

            modelBuilder.Entity("Pronto_MIA.Domain.Entities.ExternalNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pronto_MIA.Domain.Entities.InternalNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DepartmentUser", b =>
                {
                    b.HasOne("Pronto_MIA.Domain.Entities.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pronto_MIA.Domain.Entities.User", null)
                        .WithMany()
