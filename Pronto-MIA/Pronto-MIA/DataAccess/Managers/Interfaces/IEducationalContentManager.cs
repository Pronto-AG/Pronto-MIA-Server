...
namespace Pronto_MIA.DataAccess.Managers.Interfaces
{
    ...
    /// <summary>
    /// Interface declaring the operations needed of an educational content manager
    /// service.
    /// </summary>
    public interface IEducationalContentManager
    {
        /// <summary>
        /// Gets the subdirectory into which files associated with educational content
        /// are persisted.
        /// </summary>
        ...
        /// <param name="description">A description of the educational content
        /// article.</param>
        /// <param name="file">The new file associated with the educational content.
        /// </param>
        /// <returns>The updated educational content.</returns>
        /// <exception cref="QueryException">If the educational content to be
        ...
        /// <summary>
        /// Sets the status of the educational content identified by the given id to
        /// published.
        /// </summary>
        /// <param name="id">Id of the educational content to be published.</param>
        /// <returns>True if the status was changed false if the educational content
        /// was already published.</returns>
        /// <exception cref="QueryException">If the educational content to publish
        ...
        /// <exception cref="QueryException">If the educational content to change
        /// could not be found.</exception>
        ...
        /// <returns>The id of the educational content that was removed.</returns>
        /// <exception cref="QueryException">If the educational content to remove
        /// could not be found.</exception>
